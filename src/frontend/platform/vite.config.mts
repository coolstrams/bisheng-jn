...
const target = process.env.VITE_PROXY_TARGET || "http://10.3.32.18:7860";
    ...
    plugins: [
      ...
      viteStaticCopy({
        targets: [
          ...
          {
            src: ['node_modules/pdfjs-dist/build/pdf.worker.min.mjs', 'node_modules/pdfjs-dist/build/pdf.worker.mjs', 'node_modules/pdfjs-dist/build/pdf.worker.min.js'],
            dest: './'
          }
        ]
      }),
